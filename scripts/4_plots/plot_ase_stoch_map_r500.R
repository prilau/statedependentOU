...
#  2-state  #
#############
ase <- processAncStates("output/3_empirical/sdOU_r500_missingStateModel/anc_states_nstate_2_run_2.log",
...
p7 <- plotAncStatesMAP(t = ase,
  ...
  theme(legend.position.inside = c(0.6,0.81))
#p1
ggsave(paste0("figures/3_empirical/sdOU_r500_MissingStateModel/nstate_2_ase_map.pdf"), p7, width = 8, height = 6)
...
p8 <- plotAncStatesPie(t = ase,
  ...
  theme(legend.position.inside = c(0.6,0.81))
#p2
ggsave(paste0("figures/3_empirical/sdOU_r500_MissingStateModel/nstate_2_ase_pie.pdf"), p8, width = 8, height = 6)


# p3
simmaps <- read.simmap("output/3_empirical/sdOU_r500_missingStateModel/augch_nstate_2_run_2.trees", format="phylip")
stoc_map <- processStochMaps(tree,
                             simmap = simmaps,
                             states=c("0", "1", "2"))
